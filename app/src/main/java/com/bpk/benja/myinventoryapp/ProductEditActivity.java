...
import com.bpk.benja.myinventoryapp.data.ProductContract;
...
public class ProductEditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInputsize=(EditText) findViewById(R.id.editText2);
        mInputcolour=(EditText)findViewById(R.id.editText3);
        ...
        mInputcolour.setOnTouchListener(mTouchListener);
    ...
    private void saveProduct() {
        ...
        String colourString=mInputcolour.getText().toString().trim();
        ...
        values.put(ProductContract.ProductEntry.COLUMN_PRODUCT_COLOUR,colourString);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int colourColumnIndex=cursor.getColumnIndex(productContract.productEntry.COLUMN_PRODUCT_COLOUR);
